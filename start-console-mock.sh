...
echo "Starting local OpenShift console in MOCK mode (no cluster required)..."

# Run without cluster connection
BRIDGE_USER_AUTH="disabled"
BRIDGE_K8S_MODE="off-cluster"
BRIDGE_K8S_MODE_OFF_CLUSTER_SKIP_VERIFY_TLS=true
# Use a fake endpoint - the plugin will still work
BRIDGE_K8S_MODE_OFF_CLUSTER_ENDPOINT="https://fake-cluster:6443"
...
echo "NOTE: Console will show cluster connection errors, but MCP Gateway plugin will work via mock broker"
